...
`,
    ...
    // Blog 6: AI Threat Detection Software Guide
    prisma.blogPost.upsert({
      where: { slug: 'ai-threat-detection-software-guide-2026' },
      update: {},
      create: {
        ...
        coverImage: '/blog/images/ai-threat-detection-hero.png',
        content: `
...
- **CrowdStrike Charlotte AI:** Natural language threat hunting — ask "Show me all endpoints that executed PowerShell in the last 24 hours and had network connections to external IPs"
- **Microsoft Copilot for Security:** Integrates with Sentinel and Defender to provide plain-English incident summaries and remediation guidance
- **SentinelOne Purple AI:** Autonomous threat hunting and investigation using natural language queries
