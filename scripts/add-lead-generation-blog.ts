...
async function main() {
    const categorySlug = 'ai-business-tools'
    ...
    const blogPost = {
        title: 'AI Tools for Lead Generation That Actually Work',
        slug: 'ai-lead-generation-tools-that-work',
        excerpt: 'Stop wasting time on cold outreach. Discover the best AI lead generation tools that automate prospecting, enrich data, and fill your pipeline with qualified leads.',
        metaTitle: 'Best AI Lead Generation Tools in 2026: Automate Your Sales Funnel',
        metaDescription: 'Looking for high-quality leads? We tested the top AI lead generation tools to help you automate prospecting, find verified emails, and close more deals.',
        focusKeyword: 'ai lead generation tools',
        content: `
...
![AI Lead Generation Dashboard](/images/blog/ai-lead-generation-dashboard.jpg)
...
![AI Lead Gen Sales Funnel](/images/blog/ai-lead-gen-funnel.jpg)
...
`,
        ...
        coverImage: '/images/blog/ai-lead-generation-dashboard.jpg',
        published: true,
        publishedAt: new Date(),
        featured: false,
        views: 120, // Start with some views
    }
    ...
    // Add tags
    const tags = ['Sales', 'B2B', 'Lead Generation', 'Marketing', 'Automation']
